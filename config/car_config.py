...
# define the base path to the car dataset
BASE_PATH = "/home/sunny/github/datasets/cars"

# based on the base path
# derive the images path and meta file path
...
# define the percentage of validation and testing images
